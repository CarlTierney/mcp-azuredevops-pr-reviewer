...
class AzureDevOpsClient:
    ...
    def _format_review_summary(self, review_data: Dict[str, Any]) -> str:
        ...
        lines.append("---")
        lines.append("")
        lines.append("**Generated by Azure PR Reviewer v2.0.0**")
        lines.append("*Automated Code Review System with Security Analysis*")
        lines.append("*Powered by Claude AI*")
        lines.append(f"*Review timestamp: {self._get_timestamp()}*")
